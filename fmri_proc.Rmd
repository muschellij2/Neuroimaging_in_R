...
`lm` works great here (data is $T×V$)
...
rMatrix <- frequencyFilterfMRI(rMatrix, 
    tr = 2, 
    freqLo = 0.01, 
    freqHi = 0.1, 
    opt = "trig")
...
- `smoothImage` can take a FWHM (≈ 2 * Pixel Dimensions) to smooth
...
```{r nuisance_reg_run, echo = FALSE, eval = FALSE}
