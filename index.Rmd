...
## Simple Visualization: Orthographic View
...
## Simple Visualization: Slice Overlays
...
```{r ortho_overlay, message=FALSE, dependson = "bet", fig.height = 3.5, fig.width= 6}
mask = ss_t1 > 0
...
```{r cropped_ortho_overlay, message=FALSE, dependson = "bet", fig.height = 3.5, fig.width= 3.5}
...
template.mask = template.file > 0
template.file = dropEmptyImageDimensions(template.mask, 
                                         other.imgs = template.file)$other.imgs
...
```{r ants_reg_syn_ers, results='hide', message = FALSE, dependson="ants_reg_syn", fig.width=8, fig.height=4, echo = FALSE}
...
```{r double_ortho_tissue, echo = FALSE, fig.width=6, fig.height=4}
